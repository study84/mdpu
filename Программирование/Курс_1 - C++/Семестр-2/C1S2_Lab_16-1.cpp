/*
Завдання 1:
Скласти програму згідно з варіантом з задачника стор.129 (Текстовые файлы. Базовый уровень). Створити текстовий файл з інформацією. Організувати перегляд вмісту файлу. Організувати читання
і обробку даних з файлу відповідно до індивідуального завданням.
Для зберігання файлів використовувати структуру. Зберегти отримані результати в новий текстовий файл. Для розробки програми
використовувати функції.

8. "Робітник":
Прізвище; ім'я; по батькові; домашня адреса (поштовий індекс, країна,
область, район, місто, вулиця, будинок, квартира); національність; дата
народження (рік, місяць, число); № цеху; табельний номер; освіта; рік
прийняття на роботу. Вивести дані про робітників, які прийняті на роботу у
2010 році.

Завдання 2: Створити структуру, що буде імітувати роботу складу. Передбачити наступні поля: найменування, кількість, ціна, сума, артикул,
місце розташування. Акцентувати увагу на необхідності перерахування суми у разі зміни кількості або ціни. Передбачити можливість
введення, зміну та видалення товарів. Виведення відомості, про залишки на складі. Для розробки програми використовувати функції.
Для введення та виведення даних використовувати файли. Для роботи з програмою розробити систему меню.
*/
